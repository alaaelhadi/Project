<?php
    ...
    if(isset($_GET["id"])){
        try{
            ...
            $sql="UPDATE `news` SET `views`=$views WHERE `id`=?" ;
            $stmtView = $conn->prepare($sql);
            $stmtView->execute([$id]);
...
<body>
    ...
    <!-- Navbar Start -->
    <?php
        include_once("includes/NavOfIndex.php");
    ?>
    <!-- Navbar End -->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                            ...
                            <div class="d-flex align-items-center">
                                <span class="ml-3"><i class="far fa-eye mr-2"></i><?php echo $views ?></span>
                            </div>
                        </div>
                    </div>
                    <!-- News Detail End -->

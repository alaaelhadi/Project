<?php
  ...
  if($_SERVER["REQUEST_METHOD"] === "POST"){
	...
	if($categoryID > 0){
		try{
			$sql = "INSERT INTO `news`(`newsDate`, `title`, `content`, `author`, `active`, `image`, `category_id`) VALUES (?, ?, ?, ?, ?, ?, ?)";
			...
			$stmt->execute([$newsDate, $title, $content, $author, $active, $image_name, $categoryID]);
												...
												<select class="form-control" name="categoryname" id="">
													...
													<?php
														foreach($stmtCat->fetchAll() as $row){
															...
															$idCategory = $row["id"];
													?>
													<option value="<?php echo $idCategory ?>"><?php echo $category ?></option>
													<?php
														}
													?>
												</select>
